...
set A=GenshinImpact_Data\StreamingAssets\Audio\GeneratedSoundBanks\Windows
set AA=GenshinImpact_Data\StreamingAssets\AudioAssets
if exist !A! (if not exist !AA! md !AA! & xcopy "!A!\*" "!AA!\" /E /Y /I && del /Q "!A!\*" 2>nul)

set path1=%AA%\English(US)
set path2=%AA%\Japanese
set path3=%AA%\Korean
set path4=%AA%\Chinese
